...
vignette: >
  %\VignetteIndexEntry{concept_set}
...
## Codelist
A concept set can be represented as either a codelist or a concept set expression. A codelist is a named list, with each item in the list containing specific concept IDs.
```{r}
